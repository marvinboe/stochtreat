...
void Simulation_Parameters::set_parameters(ParameterHandler & parameters){
    ...
    parameters.SetValue("output", "Specifiy kind of output (). possible: 'patient,nolsctime,diagtime,reductiontime,initresponse,fullburden,nooverview,yearlyburden,lastburden,relapsetime,timepointburdenmedian,timepointburdenfull,treatdynamics,relapsedynamics,relapsedynall,print_simparams'. Can be combined: 'output=x1;x2;etc'.", output);
